...
public class TabListMethod
{
  ...
  public static void sendTablist(Player p, String msg, String msg2, Main plugin, boolean colors)
  {
    ...
    try
    {
      if ((getServerVersion().equalsIgnoreCase("v1_9_R1")) || 
        ...
        Object header = getNmsClass("IChatBaseComponent$ChatSerializer").getMethod("a", new Class[] { String.class }).invoke(null, new Object[] { "{'text': '" + "§6&lWelcome to TerraTerma" + "'}" });
        Object footer = getNmsClass("IChatBaseComponent$ChatSerializer").getMethod("a", new Class[] { String.class }).invoke(null, new Object[] { "{'text': '" + "§a§lIP: §c§lterraterma.site" + "'}" });
